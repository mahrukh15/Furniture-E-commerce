...
import logo from "../../../public/images/furni.jpg"; 
      ...
      <div className="md:sticky md:top-0 md:shadow-none z-20 relative">
        ...
        <div className="hidden lg:block animate-in fade-in zoom-in bg-white p-4">
          <div className="flex justify-between mx-[41px] items-center">
            ...
            {/* Logo Added */}
            <div>
              <Image src={logo} alt="Furni Logo" width={140} height={80} className="w-[7rem] scale-400" />
            </div>
        ...
        {/* MOBILE NAVBAR */}
        <div
          className={`${menu ? "!bg-[#FFF3E3] py-2" : ""} block lg:hidden shadow-sm fixed top-0 w-full z-[999] bg-white py-4 animate-in fade-in zoom-in`}
        >
          <div className="flex justify-between mx-[10px]">
            
            {/* Logo in Mobile */}
            <div className="flex gap-[50px] text-[16px] items-center select-none">
              <Image src={logo} alt="Furni Logo" width={140} height={80} className="w-[7rem]" />
            </div>
